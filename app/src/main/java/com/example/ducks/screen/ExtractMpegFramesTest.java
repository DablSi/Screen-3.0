...
//            th.join();
    ...
    static void doExtract(MediaExtractor extractor, int trackIndex, MediaCodec decoder,
                          CodecOutputSurface outputSurface) throws IOException, InterruptedException {
        ...
        while (!outputDone) {
            ...
            if (!outputDone) {
                ...
                if (decoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                    ...
                    Log.d(ExtractMpegFramesTest.class.getName(), "unexpected result from decoder.dequeueOutputBuffer: " + decoderStatus);
...
//                                String.format("frame-%02d.png", decodeCount % 10));
