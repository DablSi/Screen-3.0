...
public class VerticalStepViewIndicator extends View
{
    ...
    //定义默认的高度   definition default by
    private int defaultStepIndicatorNum = ((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 40, getResources().getDisplayMetrics())) * 2;

    private float mCompletedLineHeight;//完成线的高度     definition completed line by
    ...
    private Rect mRect;
    private int mHeight;//这个控件的动态高度    this view dynamic by
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        if(mStepNum > 0)
        {
            //dynamic measure VerticalStepViewIndicator by
